            ...
            {getStock?.data?.slice(0, 5).map((item, idx: number) => (
              <div className="bg-[#ffffff] rounded-lg flex justify-between lg:w-11/12 w-full py-2 px-4 mx-auto my-2">
                <div className="flex">
                  {idx <= 2 ? (
                    <div
                      ...
                      className="font-bold text-[1.6rem] bg-contain w-16 h-16 text-[#ffffff] bg-no-repeat flex justify-center pt-2">
                      {idx + 1}
                    </div>
                  ) : (
                    <div className="font-bold text-[1.8rem] w-16 h-16 text-[#F99F9F] bg-no-repeat flex justify-center pt-2">
                      {idx + 1}
                    </div>
                  )}
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="text-[1.1rem] font-bold">
                      {item.nickname}
                      <span
                        className="px-2 bg-[#F99F9F] mx-2 text-[#ffffff] rounded-full text-[0.95rem] py-[0.1rem] cursor-pointer"
                ...
                <div
                  ...
                  className="bg-contain bg-center bg-no-repeat w-16 h-16"></div>
              </div>
            ))}
          </div>
