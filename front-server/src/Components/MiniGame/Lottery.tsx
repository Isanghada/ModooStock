  ...
  return (
    <div
      ...
      <div className="pb-4 lg:pb-5">
        <button
          className={`px-4 py-1 mx-auto font-extrabold text-white rounded-3xl w-[60%]  text-[0.8rem] md:text-[0.9rem] lg:text-[1.1rem] hover:scale-110 transition-all duration-300 ${
