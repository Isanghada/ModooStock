...
const ElectricChatting = () => {
  ...
  return (
    <>
      <NewsInfo myProfile={myProfile} roomName={roomName} isNewsClick={isNewsClick} setIsNewsClick={setIsNewsClick} />
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
...
export default ElectricChatting;
