...
const Box: React.FC<{children: React.ReactNode}>  = ({ children }) => (
  <div className={`w-full lg:w-[35rem]  lg:h-[15rem] max-h-[15rem] rounded-b-xl bg-[#fff6f2] flex flex-col items-center overflow-auto
  ${
...
const UserList: React.FC<{ users: Array<UserInfo> }> = ({ users }) => (
  <>
    ...
    {users && users.length === 0 &&
      <div className='p-2 font-medium text-[0.7rem] md:text-[0.8rem] lg:text-[0.9rem] text-center text-[#707070]'>검색 결과가 없습니다.</div>}
  </>
);
