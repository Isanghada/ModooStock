...
function GuestBookList(): JSX.Element {
  const profileImg = 'https://modoostock.s3.ap-northeast-2.amazonaws.com/images/navImg/m9.png';

  return (
    <>
      <div className="flex flex-col w-[1042px] h-[544px]">
        <div className="flex w-[1042px] h-[82px] rounded-tl-lg rounded-tr-lg bg-[#fde2e2] items-center px-8 justify-between">
          ...
          <img alt="" src="/images/icons/multiply.png" className="w-[52px] h-[52px] object-cover" />
        </div>
        <div className="w-[1042px] h-[462px] rounded-bl-lg rounded-br-lg bg-[#fff6f2] border border-[#fde2e2] flex flex-wrap gap-4 px-10 pt-5">
          <div className="w-[208px] h-[204px] rounded-xl bg-white border border-[#fde2e2] p-4">
            ...
            <p className="w-[174px] h-[52px] text-base text-left text-[#747474]">안녕하세요. 왔다감</p>
          </div>

          <div className="w-[208px] h-[204px] rounded-[15px] bg-white border border-[#fde2e2]" />
          <div className="w-[208px] h-[204px] rounded-[15px] bg-white border border-[#fde2e2]" />
          <div className="w-[208px] h-[204px] rounded-[15px] bg-white border border-[#fde2e2]" />
          <div className="w-[208px] h-[204px] rounded-[15px] bg-white border border-[#fde2e2]" />
          <div className="w-[208px] h-[204px] rounded-[15px] bg-white border border-[#fde2e2]" />
