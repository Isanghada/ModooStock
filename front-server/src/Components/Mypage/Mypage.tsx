  ...
  return (
    <>
      ...
      <div className="relative flex  items-center justify-between w-full h-full overflow-y-hidden max-w-[41.6rem] max-h-[23.4rem] lg:hidden mx-auto my-auto">
        ...
        <div className="flex flex-col w-[40%] font-extrabold top-0">
            {/* 버튼 */}
            <div className="flex justify-end mb-3 text-white">
              <div className="py-1 px-5 cursor-pointer hover:scale-105 transition-all duration-300 bg-[#EA455D] rounded-full mr-2">
                <span>되팔기</span>
            ...
            {/* 에셋 이미지 & 위치 조정 및 배치*/}
            <div className="flex flex-col justify-center items-center absolute border-4 border-[#fb7c7c] rounded-3xl text-white mb-10">
              {/* 등급 */}
              <div className="flex justify-start w-full pt-2 pl-2">
                <div className="bg-[#FFC34F] px-7 py-[2px] rounded-full">
                  <span>유니크</span>
