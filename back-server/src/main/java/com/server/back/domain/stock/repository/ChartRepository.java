...
public interface ChartRepository extends JpaRepository<ChartEntity, Long> {
    ...
    Optional<Long> getAvgPriceEndByDateGreaterThanEqualAndDateLessThanEqualAndCompany(@Param("start") LocalDate start, @Param("end") LocalDate end, @Param("comapny") Long company_id);
